 ...
 */
var Database = module.exports = Type.extend({
  ...
  init: function init(config) {
    ...
    db.Field = require('./' + db.fieldProtoName);
  ...
  /**
   * Query the database with SQL, and pass results to an errback function.
   */
